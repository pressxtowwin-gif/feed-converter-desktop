...
class DataEngineRepository:
    ...
    def save_project_snapshot(self, snapshot: dict[str, Any]) -> int:
        ...
        values = {
            ...
            "restored_excel_rows": int(snapshot.get("restored_excel_rows", 0) or 0),
            "repaired_excel_apartments": int(snapshot.get("repaired_excel_apartments", 0) or 0),
            "repaired_excel_cells": int(snapshot.get("repaired_excel_cells", 0) or 0),
        ...
        with connect(self.project_dir) as conn:
            cur = conn.execute(
                ...
                INSERT INTO project_snapshot (
                    ...
                    updated_cells,
                    restored_excel_rows,
                    repaired_excel_apartments,
                    repaired_excel_cells,
                    prices_changed,
                    changes_total,
                    feed_size,
                    feed_type,
                ...
                (
                    ...
                    values["restored_excel_rows"],
                    values["repaired_excel_apartments"],
                    values["repaired_excel_cells"],
